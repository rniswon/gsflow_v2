...
A 64-bit Windows or 32-bit Linux executable is provided in the "bin" subdirectory.
After the "bin" subdirectory is included in your PATH, GSFLOW is initiated in a 
Command-Prompt window using the command:
