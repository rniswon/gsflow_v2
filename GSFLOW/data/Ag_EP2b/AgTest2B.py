...
num_lines = 0
with open(r"..\output\modflow\sagehensfr18_HighTrig.out", 'r') as f:
    for line in f:
        num_lines += 1
...
fname1 = open(r"..\output\modflow\sagehensfr18_HighTrig.out","r")
fname2 = open(r"..\output\modflow\sagehensfr19_HighTrig.out","r")
...
#open irrigation segment file again to read lines
fname1 = open(r"..\output\modflow\sagehensfr18_LowTrig.out","r")
fname2 = open(r"..\output\modflow\sagehensfr19_LowTrig.out","r")
#set firstline for headers
firstline=fname1.readline()
firstline=fname2.readline()
# store all data from file in lines
...
fname1 = open(r"..\output\modflow\sagehensfret18_HighTrig.out","r")
fname2 = open(r"..\output\modflow\sagehensfret19_HighTrig.out","r")
#set firstline for headers
...
#open SW ET file to read lines
fname1 = open(r"..\output\modflow\sagehensfret18_LowTrig.out","r")
fname2 = open(r"..\output\modflow\sagehensfret19_LowTrig.out","r")
#set firstline for headers
firstlineet=fname1.readline()
firstlineet=fname2.readline()
# set headers for plot legend
...
plt.tight_layout()
plt.savefig(r'..\output\Fig10.png')