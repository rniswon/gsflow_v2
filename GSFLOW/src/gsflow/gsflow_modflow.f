...
C
      ...
      IMPLICIT NONE
! Functions
      INTEGER, EXTERNAL:: gsfdecl, gsfinit, gsfrun
      EXTERNAL :: gsfclean
!***********************************************************************
      gsflow_modflow = 0
...
!     ------------------------------------------------------------------
     ...
     &    GSFLOW_flag, Agriculture_dprst_flag, Model
      IMPLICIT NONE
      ! Functions
...
!     ------------------------------------------------------------------
     ...
     &    Init_vars_from_file, Mxsziter, PRMS_land_iteration_flag
