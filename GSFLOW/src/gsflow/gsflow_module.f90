...
!***********************************************************************
   ...
   &    smidx_module, carea_module, ddsolrad_module, ccsolrad_module, SAVE_INIT, READ_INIT
     ...
     &          EQULS = '===================================================================='
      ...
      character(len=*), parameter :: GSFLOW_versn = '2.3.0 09/01/2021'
      character(len=*), parameter :: PRMS_versn = '2021-09-01'
      character(len=*), parameter :: PRMS_VERSION = 'Version 5.2.1 09/01/2021'
...
! Control parameters
      ...
      INTEGER, SAVE :: Prms_warmup, PRMS_land_iteration_flag, snow_cloudcover_flag
