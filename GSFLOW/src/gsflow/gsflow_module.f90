  ...
  MODULE PRMS_MODULE
   ...
   &    smidx_module, carea_module, ddsolrad_module, ccsolrad_module, SAVE_INIT, READ_INIT
     ...
     &          EQULS = '===================================================================='
      ...
      character(len=*), parameter :: GSFLOW_versn = '2.4.0 11/11/2021'
      character(len=*), parameter :: PRMS_versn = '2021-11-11'
      character(len=*), parameter :: PRMS_VERSION = 'Version 5.3.0 11/11/2021'
      character(len=*), parameter :: Version_read_control_file = '2021-11-11'
      character(len=*), parameter :: Version_read_parameter_file = '2021-11-11'
      character(len=*), parameter :: Version_read_data_file = '2021-11-11'
