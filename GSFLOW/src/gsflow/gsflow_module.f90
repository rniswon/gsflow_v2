  ...
  MODULE PRMS_MODULE
    ...
    USE PRMS_CONSTANTS
     ...
     &          EQULS = '=========================================================================='
      ...
      character(len=*), parameter :: GSFLOW_versn = '2.3.0 02/23/2023'
      character(len=*), parameter :: PRMS_versn = '2023-02-23'
      character(len=*), parameter :: PRMS_VERSION = 'Version 5.3.0 02/23/2023'
...
! Control parameters
      ...
      INTEGER, SAVE :: irrigation_apply_flag, Dyn_ag_frac_flag, Dyn_ag_soil_flag, seg2hru_flag
