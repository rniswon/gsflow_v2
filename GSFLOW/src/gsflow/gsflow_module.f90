  ...
  MODULE PRMS_MODULE
    ...
    USE PRMS_CONSTANTS
     ...
     &          EQULS = '===================================================================='
      ...
      character(len=*), parameter :: GSFLOW_versn = '2.4.0 10/26/2022'
      character(len=*), parameter :: PRMS_versn = '2022-10-26'
      character(len=*), parameter :: PRMS_VERSION = 'Version 5.3.0 10/26/2022'
