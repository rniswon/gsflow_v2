...
C
      ...
      DATA WARN1 /' ***WARNING***'/
      DATA WARN2 /'IPHDRY IS SET GREATER THAN ZERO AND THE HEAD IN DRY'/
      DATA WARN3 /'CELLS WILL BE SET TO HDRY. OBSERVATION PACKAGES ARE'/
      DATA WARN4 /'ACTIVE AND HDRY COULD BE USED TO CALCULATE OBSER-'/ 
      DATA WARN5 /'VATION VALUES. IPHDRY SHOULD BE SET TO ZERO IF'/
      DATA WARN6 /'OBSERVATION PACKAGES ARE ACTIVE.'/
!     ------------------------------------------------------------------
