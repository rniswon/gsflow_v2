      MODULE GWFSFRMODULE
        ...
        INTEGER, SAVE, POINTER :: Nfoldflbt, NUMTAB_SFR, MAXVAL
        ...
        REAL,   SAVE,  DIMENSION(:),  POINTER:: SEGFLOWS
        ...
        REAL,   SAVE,  DIMENSION(:),  POINTER:: SEGINFLOWSAVE
...
C        INTEGER,SAVE,                 POINTER:: NFLOWTYPE          !edm
      ...
      TYPE GWFSFRTYPE
        ...
        INTEGER, POINTER :: Nfoldflbt, NUMTAB_SFR, MAXVAL
        ...
        REAL,        DIMENSION(:),  POINTER:: SEGFLOWS
        ...
        REAL,          DIMENSION(:),  POINTER:: SEGINFLOWSAVE
