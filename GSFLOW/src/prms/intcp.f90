...
!***********************************************************************
     ...
     &    Hru_route_order, Hru_area, Cov_type, Snowpack_threshold, Ag_frac, gsflow_ag_area !, Ag_cov_type
...
! gain_inches_hru is water applied to whole HRU, gain_inches is water added to canopy
        ...
        IF ( Use_transfer_intcp==ACTIVE .OR. irrigation_apply_flag==CANOPY ) THEN
     ...
     &                                                   i, ', application water:', Canopy_gain(i)
              IF ( irrigation_apply_flag==CANOPY ) &
