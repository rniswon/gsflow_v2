...
! Declared Variables for gate opening routing
      ...
      CALL declvar_dble(MODNAME, 'lake_outvol', 'nlake', Nlake, 'double', &
     ...
     &     'acre-inches', Lake_outvol)
      ...
      CALL declvar_dble(MODNAME, 'lake_outvol_ts', 'nlake', Nlake, 'double', &
...
! Declared Variables for lakes with a second outlet and gate opening routing
      IF ( Nratetbl>0 .OR. Model==99 ) THEN
        CALL declvar_dble(MODNAME, 'basin_2ndstflow', 'one', 1, 'double', &
     ...
     &       'inches', Basin_2ndstflow)
        ...
        CALL declvar_dble(MODNAME, 'lake_outq2', 'nlake', Nlake, 'double', &
