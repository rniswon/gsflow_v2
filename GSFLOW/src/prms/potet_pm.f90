...
!***********************************************************************
      ...
      USE PRMS_MODULE, ONLY: Process_flag, Nhru, Humidity_cbh_flag, Nowmonth, Nmonths
      USE PRMS_POTET_PM
     ...
     &    Tempc_dewpt, Vp_actual, Lwrad_net, Vp_slope, Vp_sat, Basin_humidity, Humidity_percent
      ...
      use prms_utils, only: print_module, read_error, sat_vapor_press !, sat_vapor_press_poly
      IMPLICIT NONE
! Functions
