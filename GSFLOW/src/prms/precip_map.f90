...
!***********************************************************************
      ...
      USE PRMS_MODULE, ONLY: Process_flag, Start_year, Start_month, Start_day, Nmap2hru, Nmap, Nowmonth, Nmonths
      USE PRMS_PRECIP_MAP
...
!******Initialize HRU variables
     ...
     &                       Adjmix_rain(i,Nowmonth), Hru_area(i), Basin_obs_ppt, Tmax_allsnow_f(i,Nowmonth), i)
