...
!***********************************************************************
      ...
      IF (declparam_int(MODNAME, 'tosegment_nhm', 'nsegment', &
     &     '0', '0', '9999999', &
...
!     &     'none')/=0 ) CALL read_error(1, 'poi_gage_id')
     ...
     &     'none')/=0 ) CALL read_error(1, 'poi_gage_segment')
      ...
      IF ( declparam_int(MODNAME, 'poi_type', 'npoigages', &
     &     '1', '1', '1', &
