...
!   Local Variables
      ...
      character(len=*), parameter :: Version_soilzone_ag = '2023-08-10'
...
!***********************************************************************
     ...
     &    DEBUG_less, ERROR_param, CASCADE_OFF, MODSIM_PRMS, CLOSEZERO, DEBUG_less
     ...
     &    Iter_aet_flag, irrigation_apply_flag, Model, Dprst_ag_gain
      USE PRMS_SOILZONE
      USE PRMS_SOILZONE_AG
