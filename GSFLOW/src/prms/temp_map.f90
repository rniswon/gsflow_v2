!***********************************************************************
! Maximum, minimum, and average temperatures are distributed to each HRU
! using temperature data input as a time series of gridded
...
!***********************************************************************
      MODULE PRMS_TEMP_MAP
        ...
        character(len=*), parameter :: Version_temp_map = '2024-04-30'
        ...
        REAL, SAVE, ALLOCATABLE :: Tmax_map_adj(:, :), Tmin_map_adj(:, :), Tmax_map_adj_offset(:, :)
        ! parameters in basin:
        !    hru_area
        ! Control Parameters
      ...
      USE PRMS_MODULE, ONLY: Process_flag, Start_year, Start_month, Start_day, Nmap2hru, Nmap, Nowmonth, PRMS6_flag
      USE PRMS_TEMP_MAP
