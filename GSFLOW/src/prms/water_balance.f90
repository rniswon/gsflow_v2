...
!   Local Variables
        ...
        character(len=*), parameter :: Version_water_balance = '2022-01-12'
...
!***********************************************************************
     ...
     &    Slow_flow, Basin_perv_et, Basin_ssflow, Basin_swale_et, Slow_stor, Ssres_in, Soil_rechr, Pkwater_ante, &
